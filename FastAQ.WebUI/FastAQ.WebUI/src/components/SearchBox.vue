<template>
  <div class="search-page">
    ...
    <div class="logo-banner">
      <img :src="Logo" alt="Logo Banner" class="logo-img" />
    </div>
    <!-- 搜索框 -->
...
.search-box:focus-within {
  ...
  transform: scale(1.02); /* 新增：聚焦時微縮放 */
}

.search-icon {
  font-size: 18px;
  color: #64748b;
  transition: color 0.3s ease, transform 0.3s ease; /* 新增：平滑過渡 */
}
...
.search-box:focus-within .search-icon {
  animation: spin 0.5s ease; /* 新增：圖標旋轉動畫 */
  color: #0284c7; /* 聚焦時變色 */
}
